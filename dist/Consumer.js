...
function match(fiber, selector) {
	...
	if (
		(_a = selector.classes) === null || _a === void 0
			? void 0
			: _a.some(function (x) {
		...
		for (var _c = __values(selection.entries()), _d = _c.next(); !_d.done; _d = _c.next()) {
			...
			try {
				for (var _f = ((e_2 = void 0), __values(parents.entries())), _g = _f.next(); !_g.done; _g = _f.next()) {
					...
					if (!match(parent_1, selector)) continue; // didn't match -> skip
...
function getParents(fiber, parents) {
	...
	parents.push(fiber);
	if (fiber === null || fiber === void 0 ? void 0 : fiber._debugOwner) return getParents(fiber._debugOwner, parents);
	return parents;
}
		...
		function StyleConsumer() {
			...
			_this.render = function () {
				...
				return react_1.default.createElement(
					Comp,
					__assign({ style: style }, _this.props),
